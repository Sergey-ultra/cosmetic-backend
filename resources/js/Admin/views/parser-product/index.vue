    ...
    <form name="parser" ref="parser">
        ...
        <div class="form__group">
            <div class="button-settings">
                <buttonComponent
                    :size="'small'"
                    @click="compressAllUncompressedImages"
                >
                    Сжать несжатые картинки
                </buttonComponent>

                <buttonComponent  @click="toggleIsShowProductOptions" :size="'small'">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            ...mapActions('productParser', ['parseProductByLinkIds', 'compressAllUncompressedImages']),
